...
class Settings(BaseSettings):
    ...
    DEV_LIVENESS_PREVIEW_OCCLUSION_NO_FACE_THRESHOLD: int = Field(
        default=5,
        ge=2,
        le=30,
        description=(
            "Consecutive occluded frames (face detected but landmarks blocked) before flipping "
            "from INSUFFICIENT_EVIDENCE to NO_FACE. Frames 2 through this value show "
